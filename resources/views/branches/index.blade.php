...
@endsection
@section('content')
@vite('resources/js/functions_ajax/modules/branches/branchesMain.js')
            ...
            <div class="card-body p-4">
                <div class="text-center">
                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                        <img src=""
                            class="rounded-circle avatar-xl img-thumbnail company-logo-image" alt="company-logo-image">
                    ...
                    <h5 class="fs-16 mb-1" id="logo">Logo de la empresa</h5>
                </div>
            </div>
        </div>
        <!--end card-->
            ...
            <div class="card-body p-4">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                        <form id="branchForm"
                            data-store-url="{{ route('branches.store') }}"
                            data-update-url-base="/branches/">
                            @csrf
                            @include('branches.form-fields-branch')
                        </form>
                    </div>
                    <!--end tab-pane-->
